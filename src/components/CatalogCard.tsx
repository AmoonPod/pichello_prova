...
const CatalogCard = memo(function CatalogCard({
                    ...
                    <div className="bg-gray-100 p-2 rounded-lg border border-gray-200/80 h-full flex flex-col">
                        ...
                        <div className="flex-1 space-y-1 overflow-y-auto">
                            {product.formati && product.formati.length > 0 ? (
                                product.formati.map((formato, index) => (
    ...
    if (viewMode === "detailed") {
        ...
        return (
            <Link href={`/prodotti/${slug}`} className="group block h-full" {...linkProps}>
                {CardContent}
            </Link>
        );
    }
                ...
                <div className="flex flex-col md:flex-row h-full p-4 gap-4">
                    ...
                    <div className="flex-1 flex flex-col space-y-3">
                        ...
                        <div className="flex flex-1 flex-col sm:flex-row gap-4">
                            <div className="flex-1 bg-gray-100 p-4 rounded-lg space-y-2">
                                <div className="h-4 bg-gray-200 rounded w-1/2"></div>
                                <div className="h-8 bg-gray-200 rounded"></div>
                                <div className="h-8 bg-gray-200 rounded"></div>
                            </div>
                            <div className="w-full sm:w-1/2 bg-gray-100 p-4 rounded-lg space-y-2">
                                <div className="h-4 bg-gray-200 rounded w-1/2"></div>
