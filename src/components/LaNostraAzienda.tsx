          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-lg font-light">
                L’azienda agricola Il Pichello deve il suo nome alla storica casa contadina chiamata da sempre ‘pichel‘ (in dialetto reggiano), che poi venne italianizzato sulle carte più antiche come Pichello. La nostra azienda produce prodotti secondo il nostro metodo biorazionale, ovvero: seguendo i ritmi naturali delle stagioni, studiando con sapienza le composizioni dei vari terreni e selezionando le piante migliori senza l’utilizzo di stratagemmi moderni.
                La nostra idea di agricoltura sostenibile in montagna per offrirti un prodotto sincero!
