...
export default function Contattaci() {
  return (
    <section className="container mx-auto px-4 py-8 lg:px-8 lg:py-16">
      ...
      <div
        className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] items-start mt-8"
        id="contatti"
      >
        <ContactForm />
        <div className="text-left">
          <h3 className="font-semibold text-xl">Agricola Il Pichello S.r.l.</h3>
          <p className="mt-4 text-gray-700">
            <strong>Indirizzo:</strong> Via Dante Alighieri 141 – 42033 Marola,
            Carpineti (RE)
          </p>
